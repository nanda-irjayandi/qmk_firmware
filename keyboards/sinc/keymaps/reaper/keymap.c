...
#define MAX_LED_INDEX 116  // Maximum number of LEDs

bool is_encoder_switcher_active = false;
// int led_index = 63;
// int rgb_under[] = {1,4,8,34,40,43,46,57,59,62,65,68,104,108,112,116};

bool rgb_lookup[MAX_LED_INDEX + 1] = {false};  // Lookup table for fast checking


void setup_rgb_lookup(void) {
    int rgb_under[] = {1, 4, 8, 34, 40, 43, 46, 57, 59, 62, 65, 68, 104, 108, 112, 116};
    int size = sizeof(rgb_under) / sizeof(rgb_under[0]);

    for (int j = 0; j < size; j++) {
        if (rgb_under[j] <= MAX_LED_INDEX) {
            rgb_lookup[rgb_under[j]] = true;
        }
    }
}
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_80_with_macro( /* MacOS Layer */
    ...
    DM_PLY1, DM_PLY2,           OSM(MOD_LCTL), OSM(MOD_LALT), OSM(MOD_LGUI), LT(9, KC_SPC), LT(9, KC_SPC), OSL(8),              KC_SPC, KC_SPC, OSM(MOD_RGUI), OSM(MOD_RALT), OSM(MOD_RCTL), KC_LEFT, LT(10, KC_DOWN),       KC_RGHT
  ),
  ...
  [1] = LAYOUT_80_with_macro( /* WIN Linux BSD Layer */
    ...
    MEH(KC_F5), MEH(KC_F6),     LT(7, KC_BSPC), LGUI_T(KC_A), LALT_T(KC_S), LCTL_T(KC_D), LSFT_T(KC_F), KC_G,     KC_H, RSFT_T(KC_J), RCTL_T(KC_K), RALT_T(KC_L), RGUI_T(KC_SCLN), KC_QUOT, LT(5, KC_ENT),          KC_PGDN,
    MEH(KC_F7), MEH(KC_F8),     OSM(MOD_LSFT), KC_Z, KC_X, KC_C, KC_V, KC_B,                                      KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, OSM(MOD_RSFT), KC_UP,                                KC_END,
    DM_PLY1, DM_PLY2,           OSM(MOD_LCTL), OSM(MOD_LGUI), OSM(MOD_LALT), LT(9, KC_SPC), LT(9, KC_SPC), OSL(8),              KC_SPC, KC_SPC, OSM(MOD_RALT), OSM(MOD_RGUI), OSM(MOD_RCTL), KC_LEFT, LT(10, KC_DOWN),     KC_RGHT
  ),

  [3] = LAYOUT_80_with_macro( /* Game Layer Completed 20230909 */
    CX_ENCTOGG,            KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6,      KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_DEL,              KC_INS,
    KC_P0, KC_P1,          KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6,            KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_DEL, KC_BSPC,         KC_HOME,
    KC_P2, KC_P3,          KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T,                  KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_BSLS,          KC_PGUP,
    KC_P4, KC_P5,          LT(7, KC_CAPS), KC_A, KC_S, KC_D, KC_F, KC_G,                 KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT,                 KC_PGDN,
    KC_P6, KC_P7,          KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B,                 KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP,             KC_END,
    KC_P8, KC_P9,          KC_LCTL, KC_BSLS, KC_LALT, KC_SPC, KC_SPC, OSL(8),     KC_SPC, KC_SPC, KC_RALT, KC_RGUI, KC_RCTL, KC_LEFT, LT(10, KC_DOWN),      KC_RGHT
  ),
  ...
  [4] = LAYOUT_80_with_macro( /* Speedtyping Layer or when you are annoyed by the lag from the home row modifier TODO separate game speedype layer with dev layer the latter use space cadet */
    ...
    DM_PLY1, DM_PLY2,           KC_TRNS, KC_TRNS, KC_TRNS, LT(9, KC_SPC), LT(9, KC_SPC), OSL(8),     KC_SPC, KC_SPC, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, LT(10, KC_DOWN),     KC_RGHT
  ),
  ...
  [5] = LAYOUT_80_with_macro( /* Data Entry Layer WIP 90percent Felt incomplete */
    ...
    KC_TRNS, KC_TRNS,     KC_BSPC,     KC_KP_4, KC_KP_5, KC_KP_6, KC_KP_ENTER, KC_NO,                     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, TG(5),                 KC_PGDN,
    KC_TRNS, KC_TRNS,     KC_SPC,      KC_KP_1, KC_KP_2, KC_KP_3, KC_KP_EQUAL, KC_NO,                     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_UP,                   KC_END,
    DM_PLY1, DM_PLY2,     KC_NO,       KC_NO, KC_KP_0, KC_KP_DOT, KC_KP_DOT, OSL(8),                      KC_SPC, KC_SPC, KC_NO, KC_NO, KC_NO, KC_LEFT, LT(10, KC_DOWN),     KC_RGHT
  ),
  ...
  [8] = LAYOUT_80_with_macro( /* Function 2 MEH Layer OSL and MacroPad ACS Left Special Mod Button TOGGLE from layer 7 9 10 */
    ...
    MEH(KC_KP_7), MEH(KC_KP_8),      KC_NO, MEH(KC_Z), MEH(KC_X), MEH(KC_C), MEH(KC_V), MEH(KC_B),          MEH(KC_N), MEH(KC_M), MEH(KC_COMM), MEH(KC_DOT), MEH(KC_SLSH), KC_TRNS, MEH(KC_UP),                  MEH(KC_END),
    MEH(KC_KP_9), MEH(KC_KP_0),      KC_NO, KC_NO, KC_NO, MEH(KC_SPC), MEH(KC_SPC), KC_NO,                           MEH(KC_SPC), MEH(KC_SPC), KC_NO, KC_NO, KC_NO, MEH(KC_LEFT), MEH(KC_DOWN),                           MEH(KC_RGHT)
  ),
  ...
  [9] = LAYOUT_80_with_macro( /* Function 3 HYPR Layer ACS Left Space Bar using Layer-Tap WIP */
    ...
    HYPR(KC_KP_5), HYPR(KC_KP_6),     HYPR(KC_CAPS), HYPR(KC_A), HYPR(KC_S), HYPR(KC_D), HYPR(KC_F), HYPR(KC_G),                        HYPR(KC_H), HYPR(KC_J), HYPR(KC_K), HYPR(KC_L), HYPR(KC_SCLN), HYPR(KC_QUOT), HYPR(KC_ENT),                    HYPR(KC_PGDN),
    ...
    HYPR(KC_KP_9), HYPR(KC_KP_0),     KC_NO, KC_NO, KC_NO, MEH(KC_SPC), MEH(KC_SPC), KC_NO,                                                        HYPR(KC_SPC), HYPR(KC_SPC), KC_NO, KC_NO, KC_NO, HYPR(KC_LEFT), HYPR(KC_DOWN),                                 HYPR(KC_RGHT)
  ),

  [10] = LAYOUT_80_with_macro( /* Menu Layer NOTE the Right Mod is there for Shiroyama Encoder RGB */
    QK_MAKE,             KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6,       KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO,        KC_NO,
    RGB_MOD, RGB_RMOD,      DF(3), TG(4), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,        KC_NO, KC_NO, KC_NO, KC_NO, QK_RBT, QK_BOOT, TG(10), TG(10),      RGB_SPI,
    ...
    DM_REC1, DM_REC2,       KC_NO, DF(1), DF(0), TG(9), TG(9), TG(8),             KC_NO, KC_NO, KC_RGUI, KC_RALT, KC_RCTL, RGB_HUD, KC_NO,      RGB_HUI
  )
};
...
bool process_record_user(uint16_t keycode, keyrecord_t* record) {
    switch (keycode) {
        ...
        // case CX_LEDDN:
        //     if (record->event.pressed) {
        //         // led_index = (led_index - 1 + DRIVER_LED_TOTAL) % DRIVER_LED_TOTAL;
        //         // led_index--;
        //     } else {
        //         // rgb_matrix_set_color(led_index, 255, 255, 255);
        //     }
...
void keyboard_post_init_user(void) {
    setup_rgb_lookup(); // Initialize lookup table

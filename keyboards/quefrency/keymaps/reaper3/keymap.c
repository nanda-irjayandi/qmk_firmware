...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    rgblight_set_layer_state(3, layer_state_cmp(state, 7) || layer_state_cmp(state, 8) || layer_state_cmp(state, 9));  // Data Layer
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [10] = LAYOUT_65_with_macro( /* Menu Layer NOTE the Right Mod is there for Shiroyama Encoder RGB */
    ...
    OS_OFF, OS_ON,          KC_CAPS, KC_MPRV, KC_MPLY, KC_MNXT, QK_LOCK, KC_NO,     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, TG(6),            RGB_VAD,
